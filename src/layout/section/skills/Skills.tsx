...
export const Skills = () => {
    return (
        <StyledSkills>
            ...
            <Icon iconId={"react"} width={"120px"} height={"120px"} viewBox={"0 0 120px 120px"}/>
            <Icon iconId={"vector"} width={"120px"} height={"120px"} viewBox={"0 0 120px 120px"}/>
            <Icon iconId={"bootstrap"} width={"120"} height={"120px"} viewBox={"0 0 120px 120px"}/>
            <Icon iconId={"tailwind"} width={"120px"} height={"120px"} viewBox={"0 0 120px 120px"}/>
            <Icon iconId={"sass"} width={"120px"} height={"120px"} viewBox={"0 0 120px 120px"}/>
            <Icon iconId={"git"} width={"120px"} height={"120px"} viewBox={"0 0 120px 120px"}/>
            ...
            <Icon iconId={"github"} width={"120px"} height={"120px"} viewBox={"0 0 120px 120px"}/>
            </FlexWrapper>
        </StyledSkills>
